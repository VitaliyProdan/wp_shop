    ...
    class YITH_Shipping extends YITH_Document {
        ...
        public function show_invoice_template_customer_data () {
            ...
            if ( $ywpi_document->order->get_formatted_billing_address () ) {
                echo '<span class="invoice-from-to" > ' . __ ( "Shipping To:", 'yith-woocommerce-pdf-invoice' ) . '</span > ' . wp_kses ( $ywpi_document->order->get_formatted_shipping_address (), array ( "br" => array () ) );
            }
